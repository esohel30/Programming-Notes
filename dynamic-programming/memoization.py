...
# print(calc_fibonacci_naive(50)) this is slow and it takes forever. 
# It has a terrible runtime complexity something to the power of the golden ratio. 
# cool math problem to solve. 
